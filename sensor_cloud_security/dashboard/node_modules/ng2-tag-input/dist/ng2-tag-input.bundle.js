(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("@angular/core"), require("@angular/forms"), require("@angular/common"), require("rxjs/add/operator/debounceTime"));
	else if(typeof define === 'function' && define.amd)
		define(["@angular/core", "@angular/forms", "@angular/common", "rxjs/add/operator/debounceTime"], factory);
	else if(typeof exports === 'object')
		exports["ng2-tag-input"] = factory(require("@angular/core"), require("@angular/forms"), require("@angular/common"), require("rxjs/add/operator/debounceTime"));
	else
		root["ng2-tag-input"] = factory(root["@angular/core"], root["@angular/forms"], root["@angular/common"], root["rxjs/add/operator/debounceTime"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_2__, __WEBPACK_EXTERNAL_MODULE_3__, __WEBPACK_EXTERNAL_MODULE_24__) {
...
/******/ 	var hotCurrentHash = "e615dd77ee2ba77322e6"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var highlight_pipe_1 = __webpack_require__(27);
	var tag_component_1 = __webpack_require__(20);
	var tag_ripple_component_1 = __webpack_require__(21);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TagInputComponent = (function (_super) {
	    ...
	    TagInputComponent.prototype.appendNewTag = function (item) {
	        var newTag = new accessor_1.TagModel(item, item);
	    ...
	    TagInputComponent.prototype.onPasteCallback = function (data) {
	        ...
	        text.split(this.pasteSplitPattern)
	            .map(function (item) { return new accessor_1.TagModel(item, item); })
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AutocompleteItemModel = (function (_super) {
	...
	exports.AutocompleteItemModel = AutocompleteItemModel;
	;
	        ...
	        set: function (items) {
	            this._autocompleteItems = items ? items.map(function (item) {
	                if (typeof item === 'string') {
	                    return new accessor_1.AutocompleteItemModel(item, item);
	                }
	                else {
	                    return new accessor_1.AutocompleteItemModel(item.display, item.value);
	                }
	            }) : [];
	        },
	        enumerable: true,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TagComponent = (function () {
	    ...
	    __decorate([
	        core_1.Input(), 
	        __metadata('design:type', accessor_1.TagModel)
	                ...
	                core_1.trigger('ink', [
	                    ...
	                    core_1.transition('none => clicked', [
	                        core_1.animate(200, core_1.keyframes([
	                            core_1.style({ opacity: 1, offset: 0, width: 0, height: 0, borderRadius: '100%' }),
	                            core_1.style({ opacity: 1, offset: 0.15, width: '15%', height: '30%' }),
	                            core_1.style({ opacity: 1, offset: 0.35, width: '35%', height: '50%' }),
	                            core_1.style({ opacity: 1, offset: 0.5, width: '50%', height: '75%' }),
	                            core_1.style({ opacity: 1, offset: 0.8, width: '80%', height: '90%' }),
	                            core_1.style({ opacity: 1, offset: 1, width: '100%', height: '100%', borderRadius: '16px' })
	                        ]))
	                    ])
	                ])
	            ]
